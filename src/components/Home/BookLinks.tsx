...
export const BooksLinks = () => {
    const videojuegosDestacados = [
        {
            titulo: "The Last Adventure",
            descripcion: "Explora aventuras y emociones únicas.",
            imagenUrl:
                "https://swebtoon-phinf.pstatic.net/20240328_240/1711576904110LLXKh_JPEG/4EpisodeList_Mobile.jpg?type=crop540_540",
        },
        {
            titulo: "Racing Pro",
            descripcion: "Velocidad y adrenalina en cada carrera.",
            imagenUrl:
                "https://play-lh.googleusercontent.com/MRBqr4DVQRW2vV7omkkPvF5MEdLJtpZh3w8QUXL9BF2l5OvffsibDdXeLQQIPmFWV5M",
        },
        {
            titulo: "Fantasy World",
            descripcion: "Sumérgete en mundos llenos de magia y fantasía.",
            imagenUrl:
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZvY-S89-pdt8sMs41HmX4nWCLgBrv_2S9ig&s",
        },
    ];
            ...
            <section className="bg-gradient-to-b from-white via-blue-50 to-blue-100 text-gray-900">
                <div className="relative w-full h-screen">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-start px-8 lg:px-32 space-y-4">
                        ...
                        <p className="text-lg md:text-xl drop-shadow-sm text-gray-200 hover:text-yellow-300 transition-colors duration-700">
                            Consigue los videojuegos que quieres sin pagar todo al contado.
                            GameLoan te permite acceder a los títulos más populares y
                            devolverlos en cómodos plazos.
                        </p>
                        <div className="flex flex-wrap gap-4 mt-6">
                            <Link
                                to={"/videojuegos"}
                                className="px-6 py-3 bg-blue-600 rounded-lg shadow-lg hover:bg-blue-500 transform hover:scale-105 transition-all"
                            >
                                Empieza ahora
                            </Link>
                        </div>
                    ...
                    {[
                        {
                            ...
                            desc: "Encuentra todo tipo de títulos para todos los gustos.",
                            icon: "🎮",
                        },
                        {
                            title: "Devoluciones Fáciles",
                            desc: "Devuelve tus juegos sin complicaciones en los plazos acordados.",
                            icon: "🔄",
                        },
                        {
                            title: "Pagos Cómodos",
                            desc: "Planifica tus pagos en cómodas cuotas según tu conveniencia.",
                            icon: "💰",
                        },
                    ].map((b, i) => (
                        <div
                            key={i}
                            className="bg-white p-16 rounded-2xl shadow-xl text-center hover:shadow-2xl hover:-translate-y-3 transition-all duration-500"
                        >
                ...
                <div className="py-24 bg-gradient-to-r from-blue-50 via-blue-100 to-white text-center">
                    ...
                    <p className="text-gray-700 mb-8 text-xl">
                        Únete a GameLoan y empieza a disfrutar de tus videojuegos favoritos
                        hoy mismo.
                    </p>
                    <Link
                        to={"/videojuegos"}
                        className="px-10 py-4 bg-blue-600 rounded-lg font-bold text-white hover:bg-blue-500 transition-colors shadow-lg hover:shadow-2xl"
                    >
                        Comenzar Ahora
                    </Link>
